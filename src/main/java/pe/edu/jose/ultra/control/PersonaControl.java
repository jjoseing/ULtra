 ...
 */
package pe.edu.jose.ultra.control;
...
import pe.edu.jose.ultra.modelo.Persona;
import pe.edu.jose.ultra.servicio.PersonaServicioI;
...
public ModelAndView inicio(Locale locale, Map<String,Object> model){
    String welcome=messageSource.getMessage("welcome.message", new Object[]{"Jose Ccama"}, locale);
